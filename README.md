...
If you want to know more about using strings in R, [this introduction](https://jfjelstul.github.io/regular-expressions-tutorial/) by Joshua Fjestul is a great way to start. 
